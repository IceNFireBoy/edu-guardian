      ...
      <div className="flex flex-col gap-4">
        ...
        {isBreakActive ? (
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            {showBreakOptions && (
              <div className="mt-2 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg shadow-lg p-3 z-50 flex flex-col gap-2 min-w-[180px]">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <input type="number" min="1" value={customTime} onChange={e => setCustomTime(e.target.value)} placeholder="Custom (min)" className="w-16 px-2 py-1 rounded border dark:bg-slate-700 dark:text-white" />
